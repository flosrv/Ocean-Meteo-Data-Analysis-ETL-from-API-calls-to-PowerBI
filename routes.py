import sys
import os
from api.sql_models import engine_DW, DimStation, DimStationNonNumeric 
from api.sql_models import DimStationNumeric, DimTimeNonNumeric, DimTimeNumeric, DimTime, FactsMeteo, FactsOcean, FactsMeteoNonNumeric, FactsMeteoNumeric, FactsOceanNonNumeric, FactsOceanNumeric

# Récupère le répertoire actuel de ce fichier (routes.py)
current_dir = os.path.dirname(__file__)

# Fait un "recul" d'un répertoire pour arriver au répertoire parent (mon_projet)
parent_dir = os.path.join(current_dir, '..')

# Convertit ce chemin relatif en chemin absolu
absolute_path = os.path.abspath(parent_dir)

# Ajoute ce répertoire absolu au sys.path pour que Python puisse y chercher des modules
